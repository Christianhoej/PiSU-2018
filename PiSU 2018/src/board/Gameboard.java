...
public class Gameboard {
	...
	public GUI_Field[] lavBræt() {
        ...
        fields[i++] = new GUI_Shipping("default", "Mols Linjen", "Pris:  4000", "Mols Linjen", "Leje:  500", Color.WHITE, Color.BLACK);
        ...
        fields[i++] = new GUI_Shipping("default", "Gedser-Rostock", "Pris:  4000", "Gedser-Rostock", "Leje:  500", Color.WHITE, Color.BLACK);
        ...
        fields[i++] = new GUI_Shipping("default", "Rødby-Puttgarden", "Pris:  4000", "Rødby-Puttgarden", "Leje:  500", Color.WHITE, Color.BLACK);
        fields[i++] = new GUI_Chance("?", "Prøv lykken", "Ta' et chancekort.", new Color(204, 204, 204), Color.BLACK);
