...
public class Gameboard {
	...
	public GUI_Field[] makeBoard() {
        ...
        fields[1] = new GUI_Street(	fieldName[1][0], 
        ...
        fields[3] = new GUI_Street(	fieldName[3][0], 
        ...
        fields[6] = new GUI_Street(	fieldName[6][0], 
        ...
        fields[7] = new GUI_Chance(	fieldName[7][0], 
        							...
        							fieldMessage[3][0], 
        							new Color(204, 204, 204), Color.BLACK);
        fields[8] = new GUI_Street(	fieldName[8][0], 
        		Integer.toString(	fieldPrices[8][0]), 
        							fieldName[8][0], 
        							fieldMessage[7][0], 
        							new Color(255, 135, 120), Color.BLACK);
        fields[9] = new GUI_Street(	fieldName[9][0], 
        		Integer.toString(	fieldPrices[9][0]), 
        							fieldName[9][0], 
        							fieldMessage[8][0], 
        							new Color(255, 135, 120), 
        							Color.BLACK);
        fields[10] = new GUI_Jail(	fieldName[10][0],
        							...
        							Color.BLACK);
        fields[11] = new GUI_Street(fieldName[11][0], 
        ...
        fields[13] = new GUI_Street(fieldName[13][0], 
        		Integer.toString(	fieldPrices[13][0]), 
        							fieldName[13][0], 
        							fieldMessage[12][0], 
        							new Color(102, 204, 0), 
        							Color.BLACK);
        fields[14] = new GUI_Street(fieldName[14][0], 
        ...
        fields[16] = new GUI_Street(fieldName[16][0], 
        ...
        fields[17] = new GUI_Chance(fieldName[17][0], 
        							...
        							fieldMessage[16][0], 
        							new Color(204, 204, 204), Color.BLACK);
        fields[18] = new GUI_Street(fieldName[18][0], 
        		Integer.toString(	fieldPrices[18][0]), 
        							fieldName[18][0], 
        							fieldMessage[17][0], 
        							new Color(153, 153, 153), Color.BLACK);
        fields[19] = new GUI_Street(fieldName[19][0], 
        ...
        fields[20] = new GUI_Refuge(fieldName[20][0], 
        							...
        							fieldMessage[19][0], 
        							Color.WHITE, Color.BLACK);
        fields[21] = new GUI_Street(fieldName[21][0], 
        ...
        fields[22] = new GUI_Chance(fieldName[22][0], 
        							...
        							Color.BLACK);
        fields[23] = new GUI_Street(fieldName[23][0], 
        		Integer.toString(	fieldPrices[23][0]), 
        							fieldName[23][0], 
        							fieldMessage[22][0], 
        							Color.RED, Color.BLACK);
        fields[24] = new GUI_Street(fieldName[24][0], 
        ...
        fields[25] = new GUI_Shipping(fieldName[25][0], 
        		...
        		Integer.toString(	fieldPrices[25][0]), 
        							...
        							fieldMessage[24][0], 
        							Color.WHITE, Color.BLACK);
        fields[26] = new GUI_Street(fieldName[26][0], 
        		Integer.toString(	fieldPrices[26][0]), 
        							fieldName[26][0], 
        							fieldMessage[25][0], Color.WHITE, Color.BLACK);
        fields[27] = new GUI_Street(fieldName[27][0], 
        ...
        fields[29] = new GUI_Street(fieldName[29][0], 
        ...
        fields[34] = new GUI_Street(fieldName[34][0], 
        ...
        fields[37] = new GUI_Street(fieldName[37][0], 
        ...
        fields[39] = new GUI_Street(fieldName[39][0], 
