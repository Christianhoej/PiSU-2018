...
public class Gameboard {
	...
	public GUI_Field[] makeBoard() {
		int i =0;
		fields[i++] = new GUI_Start(fieldName[0], fieldMessage[0], fieldMessage[1], Color.RED, Color.BLACK);
        fields[i++] = new GUI_Street(fieldName[1], fieldPrices[0], fieldName[1], fieldMessage[2], new Color(75, 155, 225), Color.BLACK);
        fields[i++] = new GUI_Chance(fieldName[2],fieldName[3], fieldMessage[3], new Color(204, 204, 204), Color.BLACK);
        fields[i++] = new GUI_Street(fieldName[4], fieldPrices[1], fieldName[4], fieldMessage[4], new Color(75, 155, 225), Color.BLACK);
        fields[i++] = new GUI_Tax(fieldName[5], fieldName[6], fieldMessage[5], Color.GRAY, Color.BLACK);
        fields[i++] = new GUI_Shipping("default", "Helsingør - Helsingborg", fieldPrices[2], "Helsingør - Helsingborg", fieldMessage[6], Color.WHITE, Color.BLACK);
        fields[i++] = new GUI_Street(fieldName[8], fieldPrices[3], fieldName[8], fieldMessage[7], new Color(255, 135, 120), Color.BLACK);
